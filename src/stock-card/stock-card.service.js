...
(function() {
    ...
    service.$inject = ['$resource', '$window', 'stockmanagementUrlFactory',
        'accessTokenFactory', 'dateUtils',
        'messageService'];

    function service($resource, $window, stockmanagementUrlFactory,
                     accessTokenFactory, dateUtils, messageService) {
        ...
        function print(stockCardId) {
            var url = stockmanagementUrlFactory('/api/common/stockCards/' + stockCardId + '/print'
