...
describe('referencedata-period run', function() {
    ...
    beforeEach(function() {
        ...
        spyOn(this.periodService, 'clearProcessingPeriodsCache');
    });
    ...
    describe('post logout action', function() {
        ...
        it('should clear rights', function() {
            this.periodService.clearProcessingPeriodsCache.and.returnValue(this.$q.resolve());
            ...
            expect(this.periodService.clearProcessingPeriodsCache).toHaveBeenCalled();
        });
